...
- Fixed "update event" calendar functionality (#5)
- Implemented mandatory house setup (#6)
...
- Updated README documentation (#9)
- Created "debt overview" page layout (#10)
...
- Expense tracking and reimbursement system
- Debt overview and management
